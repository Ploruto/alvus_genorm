...
/// // -> "UserProfile"
/// ```
pub fn get_model_type_name(model: schema.Model) -> String {
...
/// }
/// ```
pub fn codegen_model_type(model: schema.Model) -> String {
  let type_name = get_model_type_name(model)
...
/// }
/// ```
pub fn codegen_model_fields(model: schema.Model) -> String {
...
/// Generates a complete model file with all necessary types and imports
pub fn generate_complete_model_file(model: schema.Model) -> String {
  let model_name = get_model_type_name(model)

  let imports = "import gleam/option.{type Option}"

  let main_type = codegen_model_type(model)
  let field_type = codegen_model_fields(model)
  let partial_type = codegen_partial_model_type(model)

  let header_comment = "// Generated by Alvus GenORM - do not edit manually
// Model: " <> model_name <> " (table: " <> model.table_name <> ")"
